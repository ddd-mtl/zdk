...
#[hdk_extern]
pub fn get_typed_children_local(parent_ta: TypedAnchor) -> ExternResult<Vec<TypedAnchor>> {
...
/// Return all children Anchors of same link-type as parent Anchor
#[hdk_extern]
pub fn get_typed_children_network(parent_ta: TypedAnchor) -> ExternResult<Vec<TypedAnchor>> {
