...
///
pub fn get_entry_for_action(action_hash: &ActionHash, strategy: GetStrategy) -> ExternResult<Option<EntryTypes>> {
   let record = match get_details(action_hash.clone(), strategy.into())? {
